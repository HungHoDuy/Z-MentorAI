...
from backend.market_scout.services.job_category_taxonomy_service import JobCategoryTaxonomyService
from backend.market_scout.services.trend_job_fact_normalizer import TrendJobFactNormalizer
